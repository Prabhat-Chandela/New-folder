...
function Input({ label,
  ...
  return (
    <div className='w-full flex relative flex-col gap-3'>
      ...
      <input type={type} className={`p-2 sm:p-3 rounded-lg bg-transparent placeholder:text-white/50 placeholder:text-xs text-red-600 outline-none focus:border-red-600  duration-200 border border-white w-full ${className}`}
        ref={ref} id={id}
        {...props} />
